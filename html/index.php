    ...
    <div class="container">
        <div class="contact-us">
            ...
            <div class="info">
                ...
                <p>we can help you to make the best version of yourself.</p>
                <div class="social">
        ...
        <div class="subscribe">
            ...
            <input class="sub-email" type="email" placeholder="email here">
            <input class="sub-button" type="submit" value="subscribe now">
        </div>
    </div>
</footer>
<!-- End Footer -->
